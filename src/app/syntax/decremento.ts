        ...
        if (this.variable.categoria == Categoria.IDENTIFICADOR) {
            ...
            if (simbolo == null) {
                ...
                if (simbolo.modificable == false) {
                    ...
                    const tmpError = new CompilacionError();
                    tmpError.error = 'solo se puede aplicar decremento a variables no a constantes: ' + this.variable.lexema + " en: " + ambito;
                    tmpError.fila = this.variable.fila;
                    tmpError.columna = this.variable.columna;
                    erroresService.agregar(tmpError);
                }
                ...
                if(!(simbolo.tipoDato == "ENTERO" || simbolo.tipoDato == "DECIMAL")) {
                    ...
                    const tmpError = new CompilacionError();
                    tmpError.error = 'solo se puede aplicar decremento a variables numericas: ' + this.variable.lexema + " en: " + ambito;
                    tmpError.fila = this.variable.fila;
                    tmpError.columna = this.variable.columna;
                    erroresService.agregar(tmpError);
                }
            ...
            const tmpError = new CompilacionError();
            tmpError.error = 'solo se puede aplicar decremento a variables: ' + this.variable.lexema + " en: " + ambito;
            tmpError.fila = this.variable.fila;
            tmpError.columna = this.variable.columna;
            erroresService.agregar(tmpError);
        }
